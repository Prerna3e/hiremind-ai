      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        {delta !== null && delta !== 0 && (
          <motion.div
            ...
            style={{
              color: delta > 0 ? "var(--accent-cyan)" : "#ef4444",
              fontSize: "0.7rem",
              fontWeight: 900,
              display: "flex",
              alignItems: "center",
              gap: "3px",
              background:
                delta > 0 ? "rgba(6, 214, 199, 0.1)" : "rgba(239, 68, 68, 0.1)",
              padding: "2px 8px",
              borderRadius: "100px",
              border: `1px solid ${delta > 0 ? "rgba(6, 214, 199, 0.2)" : "rgba(239, 68, 68, 0.2)"}`,
            }}
          >
...
const InterviewSession: React.FC<InterviewSessionProps> = (props) => {
  ...
  useEffect(() => {
    if (
      currentQuestion &&
      voiceEnabled &&
      currentQuestion !== hasSpokenRef.current
    ) {
      hasSpokenRef.current = currentQuestion;
      speak(currentQuestion);
    }
  }, [currentQuestion, voiceEnabled, speak, setupData.interviewType]);

  useEffect(() => {
    if (transcript) {
      console.log("Session received transcript:", transcript);
  ...
  return (
      <div className="full-width-container" style={{ padding: "0 40px" }}>
        {/* Header Stats */}
        <div
          style={{
            display: "flex",
        ...
        >
          <div style={{ display: "flex", gap: "30px", flexWrap: "wrap" }}>
            <div>
              ...
              >
                {setupData.interviewType.toUpperCase()}
              </div>
            </div>
            <div>
              <div
            ...
            <div>
              ...
              <div
                style={{
                  color:
                    setupData.difficulty === "hard"
                      ? "#ef4444"
                      : setupData.difficulty === "medium"
                        ? "#f59e0b"
                        : "#22c55e",
                  fontWeight: 700,
                  fontFamily: "var(--font-futuristic)",
        ...
        <div className={`interview-grid ${showCode ? "with-code" : ""}`}>
          {/* Left: AI Avatar & Chat Panel & Input Area */}
          <div
            style={{
              display: "flex",
          ...
          >
            {/* Top section: Avatar and Question */}
            ...
            <div style={{ position: "relative", marginBottom: "20px" }}>
              <div
                style={{
                  ...
                  inset: -20,
                  background:
                    "radial-gradient(circle, rgba(59, 123, 246, 0.15), transparent 70%)",
                  borderRadius: "50%",
                  zIndex: -1,
                }}
              ></div>
              <motion.div
                className="robot-avatar holographic"
                animate={
                  loading
                    ? {
                        scale: [1, 1.05, 1],
                ...
                style={{
                  ...
                  border: loading
                    ...
                    : "2px solid rgba(59, 123, 246, 0.4)",
                  padding: "5px",
                  background: "rgba(5, 8, 16, 0.9)",
                  boxShadow: loading
                    ? "0 0 60px rgba(6, 214, 199, 0.4)"
                    : "0 0 40px rgba(59, 123, 246, 0.3)",
                  overflow: "hidden",
                  position: "relative",
                }}
              >
                ...
                {isListening && (
                  ...
                  >
                    ...
                    >
                      {transcript || "Monitoring audio input..."}
                    </div>
                  </div>
                )}
                <div
                  ...
                  style={{
                    ...
                    pointerEvents: "none",
                    background:
                      "linear-gradient(to bottom, transparent 0%, rgba(6, 214, 199, 0.05) 50%, transparent 100%)",
              ...
              >
                <motion.div
                  ...
                  style={{
                    ...
                    border: `1px solid ${loading ? "var(--accent-purple)" : isListening ? "var(--accent-cyan)" : "rgba(255,255,255,0.1)"}`,
                  }}
                >
                  <Activity
                    size={10}
                ...
                {isListening && !loading && (
                  ...
                  >
                    {[1, 2, 3, 4, 5, 4, 3, 2, 1].map((_, i) => (
                      <motion.div
                        key={i}
                        animate={{ height: [4, 18, 4], opacity: [0.4, 1, 0.4] }}
                        transition={{
                          duration: 0.8,
                          repeat: Infinity,
                          delay: i * 0.1,
                  ...
                  >
                    <motion.button
                      ...
                      onClick={() => {
                        ...
                        if (!isListening) {
                          stopSpeaking(); // Stop AI when we start listening
                          startListening();
                        } else {
                          stopListening();
                        }
          ...
          {/* Col 3: Feedback & Live Analytics (or Code Editor) */}
          <div
            ...
            {showCode ? (
              ...
              >
                ...
                >
                  <div style={{ color: "#8B5CF6" }}>
                    def <span style={{ color: "#06D6C7" }}>solve_problem</span>
                    (data):
                  </div>
                  <div style={{ paddingLeft: "20px", color: "#475569" }}>
                    # Your futuristic code goes here...
                  </div>
                  <div style={{ paddingLeft: "20px", color: "#F1F5F9" }}>
                    result = []
                  </div>
                  <div style={{ paddingLeft: "20px" }}>&nbsp;</div>
                  <div style={{ paddingLeft: "20px", color: "#8B5CF6" }}>
                    for <span style={{ color: "#F1F5F9" }}>item</span> in{" "}
                    <span style={{ color: "#F1F5F9" }}>data</span>:
                  </div>
                  <div style={{ paddingLeft: "40px", color: "#F1F5F9" }}>
                    process(item)
                  </div>
                  <div style={{ paddingLeft: "20px" }}>&nbsp;</div>
                  <div style={{ paddingLeft: "20px", color: "#8B5CF6" }}>
                    return <span style={{ color: "#F1F5F9" }}>result</span>
                  </div>
                </div>
              </motion.div>
            ) : (
              <>
                  ...
                  >
                    <svg width="120" height="120" viewBox="0 0 120 120">
                      ...
                      <motion.circle
                        ...
                        animate={{
                          strokeDashoffset:
                            339.29 - (339.29 * overallScore) / 100,
                        }}
                        strokeLinecap="round"
                      />
                    </svg>
                ...
                >
                  ...
                  <GlowingScoreBar
                    label={
                      setupData.interviewType === "hr" ? "Clarity" : "Technical"
                    }
                  ...
                  {showFeedback && lastFeedback && (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Score Changes */}
                        <div
                          className="grid-cols-3-responsive"
                          style={{ marginBottom: "35px" }}
                        >
                          {[
                            {
                              label: "Technical",
                              val: lastScoreDelta?.technical,
                              color: "var(--accent-blue)",
                            },
                            {
                              label: "Comm.",
                              val: lastScoreDelta?.communication,
                              color: "var(--accent-cyan)",
                            },
                            {
                              label: "Confidence",
                              val: lastScoreDelta?.confidence,
                              color: "var(--accent-purple)",
                            },
                          ].map((s, i) => (
                            <div
                        ...
                        <motion.button
                          whileHover={{
                            scale: 1.02,
                            boxShadow: "0 0 20px rgba(6, 214, 199, 0.3)",
                          }}
                          whileTap={{ scale: 0.98 }}
